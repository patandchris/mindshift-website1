...
import { Play, ExternalLink, Download, Share, Calendar, Clock, Loader2 } from "lucide-react";
                ...
                <CardContent className="p-8">
                  <div className="grid md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="relative aspect-video rounded-lg overflow-hidden group">
                      <img 
                        src={latestEpisode.thumbnail || mamInitialsLogo} 
                    ...
                    <div>
                      ...
                      <h3 className="text-2xl font-bold mb-4">{latestEpisode.title}</h3>
                      <p className="text-muted-foreground mb-6">{latestEpisode.description}</p>
                      ...
                      <div className="flex flex-col sm:flex-row justify-center gap-2">
                        <Button 
                          ...
                          onClick={() => window.open(latestEpisode.audioUrl, '_blank')}
                        >
          ...
          <div className="container-premium">
            ...
            <div className="grid gap-6">
              {olderEpisodes.map((episode) => (
                <Card key={episode.id} className="card-premium group hover:scale-[1.01] cursor-pointer">
...
export default PodcastWithFeed;
